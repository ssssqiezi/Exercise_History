...
public class FlowLayout extends ViewGroup
{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        for(i=0;i<getChildCount();i++) {
            ...
            //wrong
            //measureChild(view, MeasureSpec.makeMeasureSpec(view.getMeasuredWidth(), widthMeasureSpec), MeasureSpec.makeMeasureSpec(view.getMeasuredHeight(), heightMeasureSpec));

            //if(view instanceof ViewGroup){
            // ........
            // }
            //wrong  : becz we need to measure the children's layout
            //view.measure(MeasureSpec.makeMeasureSpec(view.getMeasuredWidth(), MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(view.getMeasuredHeight(), MeasureSpec.EXACTLY));
            //
            if(width+view.getMeasuredWidth()>sizeWidth){
                height+=view.getMeasuredHeight();
                width =0;
            }else{
                width+=view.getMeasuredWidth()+view.getPaddingLeft()+view.getPaddingRight();
